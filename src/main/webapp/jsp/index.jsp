...
<html class="no-js" lang="en">
	...
	<body>
			    ...
			    <nav class="navbar navbar-default bootsnav  navbar-sticky navbar-scrollspy"  data-minus-value-desktop="70" data-minus-value-mobile="55" data-speed="1000">
			        ...
			        <div class="container">
			            ...
			            <div class="navbar-header">
			                ...
			                <a class="navbar-brand" href="index.html">爱健身<span>俱乐部</span></a>
			            ...
			            <div class="collapse navbar-collapse menu-ui-design" id="navbar-menu">
			                <ul class="nav navbar-nav navbar-right" data-in="fadeInDown" data-out="fadeOutUp">
			                    ...
			                    <li class="scroll"><a href="#works">健身知识</a></li>
			                    <li class="scroll"><a href="#explore">健身项目</a></li>
			                    <li class="scroll"><a href="#reviews">教练简介</a></li>
			                    <li class="scroll"><a href="#blog">留言区</a></li>
		...
		<!--works start -->
		<section id="works" class="works" style="margin-top: 80px;">
			<div class="container">
		           	...
		           	<div class="row">
			           	...
			           	<div class="col-sm-9">
			           		<ul class="footer-menu-item">
			                    <li class="scroll"><a href="#works">健身知识</a></li>
			                    <li class="scroll"><a href="#explore">健身项目</a></li>
			                    <li class="scroll"><a href="#reviews">健身简介</a></li>
			                    <li class="scroll"><a href="#blog">留言区</a></li>
			                    <li class="scroll"><a href="#contact">联系我们</a></li>
			                    <li class=" scroll"><a href="#contact">我的账号</a></li>
			                </ul><!--/.nav -->
			           	</div>
		           </div>
				</div>
